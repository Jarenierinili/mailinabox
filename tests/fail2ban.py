...
if __name__ == "__main__":
	...
	run_test(http_test, [":8443/admin/login", 200], 20, 30, 1)

	# Munin via the Mail-in-a-Box control panel
	run_test(http_test, [":8443/admin/munin/", 401], 20, 30, 1)

	# ownCloud
	run_test(http_test, [":8443/cloud/remote.php/webdav", 401, None, None, [owncloud_user, "aa"]], 20, 120, 1)
